...
static const char *fonts[]          = { "Fira Code Nerd Font Mono:pixelsize=17:antialias=true:autohint=true" };
static const char dmenufont[]       = "Fira Code Nerd Font Mono:pixelsize=17:antialias=true:autohint=true";
...
static Key keys[] = {
	...
	{ MODKEY,              XK_a,                    hideotherwins,  {0}},
	{ MODKEY|ShiftMask,    XK_a,                    restoreotherwins, {0}},
